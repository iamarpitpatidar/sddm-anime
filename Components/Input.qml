...
Column {
        ...
        ComboBox {
            ...
            delegate: ItemDelegate {
                ...
                background: Rectangle {
                    color: selectUser.highlightedIndex === index ? root.palette.highlight : "transpa    rent"
                }
            }
    ...
    Item {
        ...
        Button {
            ...
            icon.width: parent.height * 0.25
            icon.color: root.palette.text
            icon.source: Qt.resolvedUrl("../assets/icons/Password2.svg")
            ...
            states: [
                State {
                    ...
                    PropertyChanges {
                        target: showPassword
                        icon.source: Qt.resolvedUrl("../assets/icons/Password.svg")
                        icon.color: root.palette.highlight
                    }
                },
                State {
